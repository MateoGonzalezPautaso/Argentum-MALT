...
![Menu Inicial](docs/images/MenuInicial.png)
...
![Crear Jugador](docs/images/CreateCharacter.png)
...
![Barras de Estado](docs/images/Bars.png)
...
![Stats del Personaje](docs/images/Atributos.png)
...
![Armadura de cuero](docs/images/ArmaduraCuero.png)

- Armadura de placas: ofrece una defensa entre 15 y 30

![Armadura de placas](docs/images/ArmaduraPlacas.png)

- Tunica azul: ofrece una defensa entre 6 y 10

![Tunica azul](docs/images/TunicaAzul.png)

- Capucha: casco que ofrece defensa entre 1 y 4

![Capucha](docs/images/Capucha.png)

- Casco de hierro: ofrece defensa entre 4 y 8

![Casco de hierro](docs/images/CascoDeHierro.png)

- Escudo de tortuga: ofrece defensa entre 1 y 2

![Escudo de tortuga](docs/images/EscudoTortuga.png)

- Escudo de hierro: ofrece defensa entre 1 y 4

![Escudo de hierro](docs/images/EscudoDeHierro.png)

- Sombrero mágico: casco que ofrece una defensa entre 4 y 12.

![Sombrero mágico](docs/images/SombreroMagico.png)
...
![Desequipar](docs/images/CascoDeHierro.png)
...
![Mazmorra](docs/images/Mazmorra.png)
...
![Fantasma](docs/images/Fantasma.png)
...
![Editor Settings](docs/images/EditorSettings.png)
