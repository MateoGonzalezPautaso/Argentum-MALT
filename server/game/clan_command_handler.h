...
private:
    ...
    CommandResult handle_found_clan(uint16_t player_id, const std::string& args);
    CommandResult handle_join_clan(uint16_t player_id, const std::string& args);
    CommandResult handle_clan_status(uint16_t player_id);
    CommandResult handle_clan_accept(uint16_t player_id, const std::string& args);
    CommandResult handle_clan_reject(uint16_t player_id, const std::string& args);
    CommandResult handle_clan_ban(uint16_t player_id, const std::string& args);
    CommandResult handle_clan_kick(uint16_t player_id, const std::string& args);
