...
MapInteraction::ClickResult MapInteraction::resolve_click(
    QMouseEvent* event, QGraphicsView* view,
    ...
    result.valid = (result.row >= 0 && result.row < map_height &&
                    result.col >= 0 && result.col < map_width);
