...
| Tiago Calderon | NPCs, Combate PvE | Sistema de NPCs con IA autónoma (visión, movimiento, ataque), Spawn periódico configurable por mapa, Sistema de ítems/equipamiento, Penalizaciones de defensa por armadura, Golpes críticos y evasión, Skins y animaciones de NPCs por tipo con velocidad configurable, Nombres coloreados. |
